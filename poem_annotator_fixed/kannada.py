...
SEMANTIC_HINT: {"suggested_emotional_arc":"celebration","suggested_theme":"Patriotism","likely_cultural_terms":["ನಾಡು","ಸಿರಿತನ","ಕನಸು"]}""",
        "output": json.dumps({
            ...
            "cultural_entities": [
                {"term":"ನಾಡು","romanization":"nadu","category":"REGIONAL_SYMBOL","stanza_index":1,"preserved":True,"translation_note":""},
...
SEMANTIC_HINT: {"suggested_emotional_arc":"grief","suggested_theme":"Grief Loss","likely_cultural_terms":["ನೆನಪು","ನಮನ"]}""",
        "output": json.dumps({
            ...
            "cultural_entities": [
                {"term":"ನೆನಪು","romanization":"nenapu","category":"SOCIAL_CUSTOM","stanza_index":1,"preserved":True,"translation_note":"Memorial salutation is culturally specific."}
            ]
        }, ensure_ascii=False)
    }
]
