...
SEMANTIC_HINT: {"suggested_emotional_arc":"serene","suggested_theme":"Philosophy","likely_cultural_terms":["കാലടി","വഴി","അവസാനം"]}""",
        "output": json.dumps({
            ...
            "cultural_entities": [
                {"term": "കാലടി", "romanization": "Kaaladi", "category": "REGIONAL_SYMBOL", "stanza_index": 1, "preserved": False, "translation_note": "Advaita philosophical‑geographical resonance lost."}
            ]
        }, ensure_ascii=False)
    },
        ...
        "output": json.dumps({
            ...
            "stanzas": [{
                ...
                "metaphor_spans": [
                    ...
                    {"source_term": "പെരിയാറിന്റെ ഓളങ്ങൾ", "abstract_meaning": "the Periyar's waves as the rhythm of life and loss"}
                ]
            }],
            "cultural_entities": [
                {"term": "പെരിയാർ", "romanization": "Periyar", "category": "REGIONAL_SYMBOL", "stanza_index": 1, "preserved": True, "translation_note": "Sacred river retained."},
