...
SYSTEM_PROMPTS = {
    "Rajasthani": GOLD_SYSTEM_PREFIX + (
        "Language hint: read Rajasthani context carefully, including Meera Bai's Krishna Bhakti, Charan/bard tradition, "
        "desert/Thar landscape (camels, sand dunes, baoli stepwells), Rajput valor/sacrifice (sati, johar, veer rasa), "
        "and folk forms like Dhola‑Maru only when text‑supported. "
        "Named deities and historical/legendary figures (Meera, Prithviraj, Pabuji) explicitly present must not be dropped. "
...
# ── Rajasthani examples (all invalid enums replaced) ───────────────────────
RAJASTHANI_EXAMPLES = [
    # 1. Mhari Khandani Zindagi – ancestral pride, palaces
    {
        "input": """POEM_ID: MV++_1229
LANGUAGE: Rajasthani
STANZA_COUNT: 1
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"pride","suggested_theme":"Heritage","likely_cultural_terms":["महलों","नैणां"]}""",
        "output": json.dumps({
            ...
            "stanzas": [{
                ...
                "metaphor_spans": [
                    {"source_term": "नैणां री सासां", "abstract_meaning": "moments of perception as the breaths of the eyes – intimate, soulful awareness of ancestral bliss"}
                ]
            }],
            "cultural_entities": [
                {"term": "महलों", "romanization": "mahlon", "category": "REGIONAL_SYMBOL", "stanza_index": 1, "preserved": True, "translation_note": "Palaces as markers of Rajput heritage retained, though the specific Rajput cultural space connotation is weakened."}
            ]
        }, ensure_ascii=False)
    },
    # 2. Rangila Rajasthan – patriotic/hospitable, desert as colorful
    {
        "input": """POEM_ID: MV++_1231
LANGUAGE: Rajasthani
STANZA_COUNT: 1
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"joy","suggested_theme":"Patriotism","likely_cultural_terms":["राजस्थान","थार","खुशीयां"]}""",
        "output": json.dumps({
            ...
            "stanzas": [{
                ...
                "loss_note": "",
                "metaphor_spans": [
                    {"source_term": "रंगीलो", "abstract_meaning": "vibrancy as the essence of Rajasthani identity, turning even the desert into a canvas of color"},
                    {"source_term": "खुशीयां सांचो बारां", "abstract_meaning": "happiness is always near – the Thar as a place of perpetual welcome and abundance"}
                ]
            }],
            "cultural_entities": [
                {"term": "राजस्थान", "romanization": "Rajasthan", "category": "REGIONAL_SYMBOL", "stanza_index": 1, "preserved": True, "translation_note": ""},
                {"term": "थार", "romanization": "Thar", "category": "REGIONAL_SYMBOL", "stanza_index": 1, "preserved": True, "translation_note": ""}
            ]
        }, ensure_ascii=False)
    },
    # 3. Thar Ri Reeti – tradition, earth, spirituality
    {
        "input": """POEM_ID: MV++_1232
LANGUAGE: Rajasthani
STANZA_COUNT: 1
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"reverence","suggested_theme":"Philosophy","likely_cultural_terms":["थार","रीती","अंगनां","मिट्टी"]}""",
        "output": json.dumps({
            ...
            "stanzas": [{
                ...
                "metaphor_spans": [
                    {"source_term": "मिट्टी रो रंग", "abstract_meaning": "the hue of the earth as the humble, mortal essence of existence and return to origin"},
                    {"source_term": "सजग", "abstract_meaning": "awakened grace in daily acts / sacrality of mundane life"}
                ]
            }],
            "cultural_entities": [
                {"term": "थार", "romanization": "Thar", "category": "REGIONAL_SYMBOL", "stanza_index": 1, "preserved": False, "translation_note": "Desert as spiritual ground flattened."},
                {"term": "रीती", "romanization": "reeti", "category": "SOCIAL_CUSTOM", "stanza_index": 1, "preserved": False, "translation_note": "Traditional custom lost."},
                {"term": "अंगनां", "romanization": "angna", "category": "REGIONAL_SYMBOL", "stanza_index": 1, "preserved": False, "translation_note": "Courtyard's domestic sacredness lost; rendered as generic space."}
            ]
        }, ensure_ascii=False)
    },
    # 4. Meera bhajan – Krishna devotion
    {
        "input": """POEM_ID: MV++_1234
LANGUAGE: Rajasthani
STANZA_COUNT: 1
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"devotion","suggested_theme":"Devotion","likely_cultural_terms":["मीरां","गिरिधर नागर","चरण कमल"]}""",
        "output": json.dumps({
            ...
            "stanzas": [{
                ...
                "metaphor_spans": [
                    {"source_term": "चरण कमल", "abstract_meaning": "lotus feet as the ultimate refuge and object of the devotee's complete surrender"}
                ]
            }],
            "cultural_entities": [
                {"term": "मीरां", "romanization": "Meera", "category": "REGIONAL_SYMBOL", "stanza_index": 1, "preserved": True, "translation_note": ""},
                {"term": "गिरिधर नागर", "romanization": "Giridhar Nagar", "category": "DEITY", "stanza_index": 1, "preserved": False, "translation_note": "Epithet flattened to generic Lord; Govardhan‑lifting miracle erased."}
            ]
        }, ensure_ascii=False)
    }
]
...
def build_prompt_from_preprocessed(poem: PreprocessedPoem, semantic_context: dict) -> tuple[str, str, str]:
    ...
    example_text = format_examples(RAJASTHANI_EXAMPLES)
