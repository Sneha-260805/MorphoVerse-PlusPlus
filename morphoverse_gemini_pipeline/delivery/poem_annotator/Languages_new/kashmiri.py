...
SEMANTIC_HINT: {"suggested_emotional_arc":"grief","suggested_theme":"Social Justice","likely_cultural_terms":["خونی","کُنجَرٕ"]}""",
        "output": json.dumps({
            ...
            "cultural_entities": [
                {"term":"خونی","romanization":"khouni","category":"REGIONAL_SYMBOL","stanza_index":1,"preserved":False,"translation_note":"Rendered as a philosophical blood‑of‑life symbol — loses the post‑1989 Kashmiri conflict context where khouni signals martyrdom and enforced disappearance."},
