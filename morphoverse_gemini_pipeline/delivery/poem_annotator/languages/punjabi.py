...
SYSTEM_PROMPTS = {
    "Punjabi": GOLD_SYSTEM_PREFIX + (
        "Language hint: you are one of the greatest living Punjabi poets and literary scholars — "
        "a figure who carries within you Bulleh Shah's Sufi kafi, Waris Shah's Heer, "
        "Shiv Kumar Batalvi's aching romanticism, Amrita Pritam's partition grief, "
        "and the revolutionary folk tradition of the dhadi vaar. "
        "The partition of 1947 split the Punjab in two and you carry this wound: "
        "Lahore is a ghost city in Punjabi poetry, and every poem about home is also about loss. "
        "You understand that a word like 'maan' or 'dharti' carries a specific weight "
        "in Punjabi that no English equivalent can match. "
...
# ── Punjabi few‑shot examples (partial / faithful / lost) ──────────────────
PUNJABI_EXAMPLES = [
    # partial – Partition lament, Heer invocation partially lost
    {
        "input": """POEM_ID: MV++_1213
LANGUAGE: Punjabi
STANZA_COUNT: 1
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"grief","suggested_theme":"Grief Loss","likely_cultural_terms":["ਵਾਰਿਸ ਸ਼ਾਹ","ਕਿਤਾਬ-ਏ-ਇਸ਼ਕ","ਵੈਨ"]}""",
        "output": json.dumps({
            ...
            "cultural_entities": [
                {"term": "ਵਾਰਿਸ ਸ਼ਾਹ", "romanization": "Waris Shah", "category": "REGIONAL_SYMBOL", "stanza_index": 1, "preserved": True, "translation_note": ""},
                {"term": "ਕਿਤਾਬ-ਏ-ਇਸ਼ਕ", "romanization": "Kitaab‑e‑Ishq", "category": "DEVOTIONAL_CONCEPT", "stanza_index": 1, "preserved": False, "translation_note": "Rendered as 'book of love' — loses the specific Heer Ranjha reference."},
                {"term": "ਵੈਨ", "romanization": "vain", "category": "SOCIAL_CUSTOM", "stanza_index": 1, "preserved": False, "translation_note": "Punjabi women's mourning form flattened to 'saga of pain'."}
            ]
        }, ensure_ascii=False)
    },
    # faithful – grief/loss, clay metaphor, no cultural entities
    {
        "input": """POEM_ID: MV++_1215
LANGUAGE: Punjabi
STANZA_COUNT: 2
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"grief","suggested_theme":"Grief Loss","likely_cultural_terms":[]}""",
        "output": json.dumps({
            ...
            "stanzas": [
                {"index":1,"emotion":"grief","tone":"tenderness","translation_quality":"faithful","loss_note":"","metaphor_spans":[]},
                {"index":2,"emotion":"grief","tone":"lament","translation_quality":"faithful","loss_note":"","metaphor_spans":[]}
            ],
            "cultural_entities": []
        }, ensure_ascii=False)
    },
    # lost – feminist literary symbol entirely erased
    {
        "input": """POEM_ID: MV++_1227
LANGUAGE: Punjabi
STANZA_COUNT: 3
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"grief","suggested_theme":"Social Justice","likely_cultural_terms":["ਚਾਦਰ ਮੈਲੀ"]}""",
        "output": json.dumps({
            "recitation_style": "reflective",
            "emotional_arc": "grief",
            "stanzas": [
                {"index":1,"emotion":"grief","tone":"lament","translation_quality":"lost","loss_note":"Chadar maili (soiled blanket) is the title and central metaphor of Rajinder Singh Bedi's landmark Punjabi novel about a widow forced into levirate marriage — the symbol of the widow's compromised dignity is reduced to a generic existential metaphor, erasing the feminist literary tradition behind it.","metaphor_spans":[]},
                {"index":2,"emotion":"grief","tone":"tenderness","translation_quality":"faithful","loss_note":"","metaphor_spans":[]},
                {"index":3,"emotion":"grief","tone":"lament","translation_quality":"partial","loss_note":"The Punjabi 'kahaniyan vich jhakkan' (peering into stories) invokes the oral kissa tradition — the chadar as the site of community storytelling — entirely absent.","metaphor_spans":[]}
            ],
            "cultural_entities": [
                {"term":"ਚਾਦਰ ਮੈਲੀ","romanization":"Chadar Maili","category":"SOCIAL_CUSTOM","stanza_index":1,"preserved":False,"translation_note":"Soiled blanket — the iconic symbol of Bedi's feminist novel, stripped of its literary and social meaning."}
            ]
        }, ensure_ascii=False)
    }
]
...
def build_prompt_from_preprocessed(poem: PreprocessedPoem, semantic_context: dict) -> tuple[str, str, str]:
    ...
    example_text = format_examples(PUNJABI_EXAMPLES)
