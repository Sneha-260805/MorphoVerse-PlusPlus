...
SYSTEM_PROMPTS = {
    "Sindhi": GOLD_SYSTEM_PREFIX + (
        "Language hint: read Sindhi context carefully, including Shah Abdul Latif Bhittai's Sur poetry and its seven heroines, "
        "Sindhu/Indus river imagery, Sufi Ishq vocabulary, Hindu Sindhi Jhulelal/Darya Shah devotion, and partition/displacement trauma only when text‑supported. "
        "Do not conflate Sufi and Hindu Sindhi registers; annotate strictly by textual evidence. "
        "Named saints and legendary figures explicitly present must not be dropped. "
...
# ── Sindhi examples – invalid labels normalized ────────────────────────────
SINDHI_EXAMPLES = [
    # 1. Pyar Ja Geet – romantic/cosmic celebration
    {
        "input": """POEM_ID: MV++_1243
LANGUAGE: Sindhi
STANZA_COUNT: 1
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"celebration","suggested_theme":"Love Romance","likely_cultural_terms":["پيار","گيت","سورج"]}""",
        "output": json.dumps({
            ...
            "stanzas": [{
                ...
                "metaphor_spans": [
                    {"source_term": "پيار جا گيت", "abstract_meaning": "love given voice through song / devotion made audible"},
                    {"source_term": "اکيون جو پيغام", "abstract_meaning": "eyes as silent messengers of the soul's affection"}
                ]
            }],
            "cultural_entities": []
        }, ensure_ascii=False)
    },
    # 2. Wah Jo Dharti – devotional love for homeland
    {
        "input": """POEM_ID: MV++_1244
LANGUAGE: Sindhi
STANZA_COUNT: 1
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"devotion","suggested_theme":"Devotion","likely_cultural_terms":["ڌرتي","سرهاڻ"]}""",
        "output": json.dumps({
            ...
            "stanzas": [{
                ...
                "metaphor_spans": [
                    {"source_term": "ڌرتي", "abstract_meaning": "homeland as the spiritual beloved, source of identity"},
                    {"source_term": "سرهاڻ جو گل", "abstract_meaning": "offering of devotion adorned on the body / fragrance as the invisible bond of love"}
                ]
            }],
            "cultural_entities": [
                {"term": "ڌرتي", "romanization": "Dharti", "category": "REGIONAL_SYMBOL", "stanza_index": 1, "preserved": False, "translation_note": "Sacred Sindhi land reduced to generic 'land'."},
                {"term": "سرهاڻ", "romanization": "serhano", "category": "SOCIAL_CUSTOM", "stanza_index": 1, "preserved": False, "translation_note": "Garland offering custom flattened."}
            ]
        }, ensure_ascii=False)
    },
    # 3. Khamosh Raat – grief, nocturnal, Sufi introspection
    {
        "input": """POEM_ID: MV++_1246
LANGUAGE: Sindhi
STANZA_COUNT: 1
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"grief","suggested_theme":"Philosophy","likely_cultural_terms":["رات","دل","اکيون"]}""",
        "output": json.dumps({
            ...
            "stanzas": [{
                ...
                "metaphor_spans": [
                    {"source_term": "خاموش رات", "abstract_meaning": "sacred darkness where inner truth emerges / the Sufi's introspective hour"},
                    {"source_term": "اکيون رت", "abstract_meaning": "weeping so profound it becomes blood / emotional exhaustion made visible"}
                ]
            }],
            "cultural_entities": [
                {"term": "رات", "romanization": "raat", "category": "DEVOTIONAL_CONCEPT", "stanza_index": 1, "preserved": True, "translation_note": "Night as spiritual unveiling partially maintained."}
            ]
        }, ensure_ascii=False)
    },
    # 4. Classical Sufi couplet – ishq, saqi
    {
        "input": """POEM_ID: MV++_1248
LANGUAGE: Sindhi
STANZA_COUNT: 1
STANZAS:
[STANZA 1]
...
SEMANTIC_HINT: {"suggested_emotional_arc":"longing","suggested_theme":"Devotion","likely_cultural_terms":["ساقي","عشق","مئخانو"]}""",
        "output": json.dumps({
            "recitation_style": "devotional",
            ...
            "stanzas": [{
                ...
                "loss_note": "",
                "metaphor_spans": [
                    {"source_term": "عشق جو جام", "abstract_meaning": "cup of divine love as intoxication of the soul / spiritual ecstasy"},
                    {"source_term": "مئخاني ۾", "abstract_meaning": "the heart as the tavern where the divine cupbearer pours spiritual wine"}
                ]
            }],
            "cultural_entities": [
                {"term": "ساقي", "romanization": "saqi", "category": "DEVOTIONAL_CONCEPT", "stanza_index": 1, "preserved": True, "translation_note": "Sufi cupbearer archetype preserved."},
                {"term": "عشق", "romanization": "ishq", "category": "DEVOTIONAL_CONCEPT", "stanza_index": 1, "preserved": True, "translation_note": ""}
            ]
        }, ensure_ascii=False)
    }
]
...
def build_prompt_from_preprocessed(poem: PreprocessedPoem, semantic_context: dict) -> tuple[str, str, str]:
    ...
    example_text = format_examples(SINDHI_EXAMPLES)
