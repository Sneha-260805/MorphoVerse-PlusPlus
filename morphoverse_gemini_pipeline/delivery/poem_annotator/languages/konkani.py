...
SEMANTIC_HINT: {"suggested_emotional_arc":"longing","suggested_theme":"Nature","likely_cultural_terms":["मांडो","कान्तार"]}""",
        "output": json.dumps({
            ...
            "cultural_entities": [
                {"term": "मांडवाच्या", "romanization": "mandvaachya", "category": "MUSICAL_TRADITION", "stanza_index": 1, "preserved": False, "translation_note": "Goan musical tradition (mandó) completely lost."},
