...
GOLD_SYSTEM_PREFIX = (
    ...
    "CRITICAL: Hindi poetry is dense with cultural allusions from the Bhakti tradition, Ramayana, Mahabharata, and Sanskrit cosmology. "
    "Expect 2-6 cultural entities per poem: deities (Ram, Krishna, Sita, Hanuman), devotional concepts (dharma, karma, moksha, vanavas, bhakti, maya), "
    "place names (Ayodhya, Mathura, Vrindavan, Ganga), literary forms (doha, chaupai), historical figures (Kabir, Mirabai, Tulsidas). "
    "Identify 1-3 true metaphors per stanza — Hindi Bhakti and Chhayavad poetry rarely lack figurative language. "
...
SEMANTIC_HINT: {"suggested_emotional_arc":"grief","suggested_theme":"Grief Loss","likely_cultural_terms":["वनवास","राम","सीता","धरती माँ"]}""",
        "output": json.dumps({
            ...
            "cultural_entities": [
                ...
                {"term":"सीता","romanization":"Sita","category":"DEITY","stanza_index":2,"preserved":True,"translation_note":""},
