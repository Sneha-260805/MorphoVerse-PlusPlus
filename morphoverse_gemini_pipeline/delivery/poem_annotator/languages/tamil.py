...
SEMANTIC_HINT: {"suggested_emotional_arc":"devotion","suggested_theme":"Philosophy","likely_cultural_terms":["கம்பன்","கங்கை"]}""",
        "output": json.dumps({
            ...
            "stanzas": [
                ...
                {"index":2,"emotion":"devotion","tone":"wonder","translation_quality":"partial","loss_note":"The Ganga in Tamil poetry often serves as a contrast to the Kaveri, marking the boundary between Sanskritic and Tamil sacred geography; 'the Ganges, in its essence' abstracts this tension.","metaphor_spans":[]}
            ],
            "cultural_entities": [
                {"term":"கம்பனெழுதின","romanization":"Kamban-ezhutina","category":"REGIONAL_SYMBOL","stanza_index":1,"preserved":True,"translation_note":""},
                {"term":"இசைமயமாக்","romanization":"isaimayamaak","category":"MUSICAL_TRADITION","stanza_index":1,"preserved":False,"translation_note":"Tamil prosodic term rendered generically."},
